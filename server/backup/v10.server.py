    ...
    def modify_element_in_store(entry_sequence, modified_element):
        ...
        try:
            for key, value in board.items():
                ...
                board[entry_sequence] = "{},{},{},{}".format(modified_element,pre_id, lc, ts)
            success = True
        except Exception as e:
            print e
        return success
    ...
    def client_action_received(element_id):
        ...
        try:
            ...
            if int(action_dom) == 0:
                ...
                propagate_to_vessels('/propagate/modify/{}/{}/{}/{}'.format(element_id,node_id,LC,TS),modified_element,'POST')
            elif int(action_dom) == 1:
                delete_element_from_store(element_id)
                propagate_to_vessels('/propagate/delete/{}/{}/{}/{}'.format(element_id, node_id,LC,TS))
            return True
        except Exception as e:
            print e
        return False
